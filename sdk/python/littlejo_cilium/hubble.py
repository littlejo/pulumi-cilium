...
class HubbleArgs:
    def __init__(__self__, *,
                 relay: Optional[pulumi.Input[builtins.bool]] = None,
                 ui: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Hubble resource.
        :param pulumi.Input[builtins.bool] relay: Deploy Hubble Relay (Default: `true`).
        :param pulumi.Input[builtins.bool] ui: Enable Hubble UI (Default: `false`).
        """
    ...
    @property
    @pulumi.getter
    def relay(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @relay.setter
    def relay(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "relay", value)

    @property
    @pulumi.getter
    def ui(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ui.setter
    def ui(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("cilium:index/hubble:Hubble")
class Hubble(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            relay: Optional[pulumi.Input[builtins.bool]] = None,
            ui: Optional[pulumi.Input[builtins.bool]] = None) -> 'Hubble':
        """
    ...
    @property
    @pulumi.getter
    def relay(self) -> pulumi.Output[builtins.bool]:
        """
        Deploy Hubble Relay (Default: `true`).
        """
        return pulumi.get(self, "relay")
    ...
    @property
    @pulumi.getter
    def ui(self) -> pulumi.Output[builtins.bool]:
        """
        Enable Hubble UI (Default: `false`).
        """
        return pulumi.get(self, "ui")
