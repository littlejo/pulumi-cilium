...
class KubeproxyFreeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of DaemonSet (Default: `kube-proxy`).
        :param pulumi.Input[builtins.str] namespace: Namespace in which to install (Default: `kube-system`).
        """
        if name is not None:
...
@pulumi.type_token("cilium:index/kubeproxyFree:KubeproxyFree")
class KubeproxyFree(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None) -> 'KubeproxyFree':
        """
